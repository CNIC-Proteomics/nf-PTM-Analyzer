...
nextflow \
    ...
    run main.nf   \
        -profile singularity \
        --quant_file "samples/heteroplasmic_liver/inputs/q_all.tsv" \
        --pgm_file "samples/heteroplasmic_liver/inputs/DMTable_PeakAssignation_FDRfiltered_DM0S_PA_T_PeakAssignation_SS_Liver_FDR_PDMTable_GM_J_PGM_Table_pgmFreq.tsv" \
        --params_file "samples/heteroplasmic_liver/inputs/params_nf.yml" \
        --compa_file "samples/heteroplasmic_liver/inputs/limma_comparisons.tsv" \
        --qmeta_file "samples/heteroplasmic_liver/inputs/myMitocarta.tsv" \
...
nextflow \
    ...
    run main.nf   \
        -profile singularity \
        --quant_file "samples/heteroplasmic_muscle/inputs/q_all.tsv" \
        --pgm_file "samples/heteroplasmic_muscle/inputs/DMTable_PeakAssignation_FDRfiltered_DM0S_PA_T_PeakAssignation_SS_Muscle_FDR_PDMTable_GM_J_PGM_Table_pgmFreq.tsv" \
        --params_file "samples/heteroplasmic_muscle/inputs/params_nf.yml" \
        --compa_file "samples/heteroplasmic_muscle/inputs/limma_comparisons.tsv" \
        --qmeta_file "samples/heteroplasmic_muscle/inputs/myMitocarta.tsv" \
